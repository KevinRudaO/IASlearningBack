...
public class ProductRequestEdit implements ApplicationRequest {
    ...
    public ProductRequestEdit(int productId, String name, String description, float basePrice, float taxRate, String productStatus, int inventoryQuantity) {
        ProductId = productId;
        Name = name;
    ...
    public boolean equals(Object o) {
        ...
        ProductRequestEdit that = (ProductRequestEdit) o;
